...
public class AnomalyDetectorJob implements Writeable, ToXContentObject, ScheduledJobParameter {
    ...
    public static final String LEGACY_OPENDISTRO_ANOMALY_DETECTOR_JOB_INDEX = ".opendistro-anomaly-detector-jobs";
    public static final String ANOMALY_DETECTOR_JOB_INDEX = ".anomaly-detector-jobs";
